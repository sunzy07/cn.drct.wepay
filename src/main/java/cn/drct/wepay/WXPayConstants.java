...
public class WXPayConstants {
    ...
    public static final String TRANSFERSQUERY_URL = BASE_URL+"mmpaymkttransfers/gettransferinfo";
    ...
    public static final String SANDBOX_TRANSFERSQUERY_URL = SANDBOX_BASE_URL+"mmpaymkttransfers/gettransferinfo";
